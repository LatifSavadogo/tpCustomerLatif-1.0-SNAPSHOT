...
/**
 * @RequestScoped Gère la persistance des Customers Façade pour gerer les
 * customers
...
public class CustomerManager {
     ...
     * il correspond à l'unité de persistance qui représente la source de
     * données de nom JNDI "jdbc/customer"
     */
    @PersistenceContext(unitName = "customerPU")
    private EntityManager em;

    /**
     *  * @Transactional car on va modifier la base de donnée et toute
     * modification doit être obligatoirement faite dans une transaction
     * @param customer
     * @return 
     *
     */
