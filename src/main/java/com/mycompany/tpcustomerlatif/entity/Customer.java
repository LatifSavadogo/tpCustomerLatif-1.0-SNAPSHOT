 ...
 */
package com.mycompany.tpcustomerlatif.entity;
...
@Table(name = "customer") // Table indique à quelle table de la base de données est liée l'entité.
@XmlRootElement
@NamedQueries({
...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.tpcustomerlatif.entity.Customer[ customerId=" + customerId + " ]";
    }
